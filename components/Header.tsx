...
export function Header({ user, onNavigate, onLogout }: HeaderProps) {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-8 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md sticky top-0 z-40 border-b border-gray-100 dark:border-neutral-900">
