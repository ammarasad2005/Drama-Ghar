...
function PageContent({ params }: { params?: any }) {
  ...
  return <HomeScreen onNavigate={handleNavigate} user={user} initialParams={initialParams} {...params} onChannelClick={(c: string) => { window.location.href = `/schedule?channel=${c}`; }} />;
}
